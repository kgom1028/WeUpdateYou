...
public class MoPubStreamAdPlacer {
    ...
    public int myRemoveAdsInRange(int originalStartPosition, int originalEndPosition) {
        int[] positions = mPlacementData.getPlacedAdPositions();
        ...
        int clearedAdsCount = mPlacementData.removeAdsInRange(adjustedStartRange, adjustedEndRange);
        for (int position : removedPositions) {
            mAdLoadedListener.onAdRemoved(position);
        }
        return clearedAdsCount;
